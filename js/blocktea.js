...
function escCtrlCh(str) {  // escape control chars etc which might cause problems with encrypted texts
	return str.replace(/[^\w]/g, function(c) { e = c.charCodeAt(0).toString(16); if(e.length == 1) e = '0' + e; return '$' + e; });
}

function unescCtrlCh(str) {  // unescape potentially problematic nulls and control characters
	return str.replace(/\$[0-9a-f]{2}/g, function(c) { return String.fromCharCode(parseInt(c.slice(1,3), 16)); });
}