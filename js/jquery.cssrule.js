...
(function( $ ){
  $.cssRule = function (Selector, Property, Value) {
    ...
    // jQuery.CssRule need at least one Style Sheet enabled on the page.
    styleSheetsLength = $('#jquerycssrule').length;
    if(styleSheetsLength == 0){
      ...
      if(!document.createStyleSheet){
        ...
        styleSheet.setAttribute("id", "jquerycssrule");
        //if(styleSheetsLength == 0){
    ...
    //for(var i = 0; i < document.styleSheets.length; i++){
      ...
      try{
	      ...
	      for(var i2 = 0, len = Rules.length || 0; i2 < len; i2++){
